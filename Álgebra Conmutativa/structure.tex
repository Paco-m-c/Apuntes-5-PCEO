...
\fancyfoot[C]{Álgebra Conmutativa}
%HACER
...
\newtheorem{corollaryt}[propositiont]{\color{turquoise}Corolario}
\newtheorem{teoremote}[propositiont]{\color{turquoise}Teorema}
\newtheorem{lemmat}[propositiont]{\color{turquoise}Lema}
