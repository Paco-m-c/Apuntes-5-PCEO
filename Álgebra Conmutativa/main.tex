...
\section*{Anillos noetherianos y artinianos}
...
\begin{demonstration}
    ...
    Se trata de probar que $ x = x_{F'} $, sea $ t \in S $ arbitrario $ \implies$
...
%2.7
\begin{proposition}
    Si $ A $ es noetherianos, entonces todo ideal contiene un producto finito de ideales principales
\end{proposition}
