...
\begin{proposition}
    ...
    \begin{enumerate}
        ...
        \item Se los $ \operatorname{Ker}(g_i) $ son comaximales dos a dos, entonces se verifica:
            \begin{enumerate}
...
\begin{demonstration}    
    ...
    Si probamos ahora que $ (0,...,x_i,0,...,0) \in \operatorname{Im}(\phi)\ \forall  x_i \in \operatorname{Im}(g_i) $, entonces toda $n$-upla $(x_1,...,x_n) \in \operatorname{Im}(\phi)  $ en $ \operatorname{Im}(\phi_1)\times...\times \operatorname{Im}(\phi_n) $ comaximales dos a dos.
    ...
    Como $ x \in \operatorname{Im}(g_i) \implies \exists u \in A:\ g_i(u) = x_i $, entonces:
...
\begin{definition}
    ...
    Un \textbf{conjunto inductivo} es un conjunto ordenado $ S $ tal que todo subconjunto totalmente ordenado no vacío tiene un acota superior en $ S $
\end{definition}
...
\begin{proposition}
    ...
    Dado $ I \unlhd A $ ideal propio, el subconjunto $ \sqrt{I}  $ es un ideal radical de $ A $ y puede ser descrito por cada una de las siguientes formas equivalentes:
    \begin{enumerate}
...
\begin{demonstration}
    ...
    $$ a,x \in \sqrt{I} \implies \exists m,n>0:\ x^{m} \in I,\ y^{n} \in I $$
...
Sea $ q \in A $ irreducible $ \implies q \not \in \mathcal{U}(A) \iff (q) \unlhd A\ (y\ propio)\ \implies (q) \subset (p) \implies q=pu$, para algún $ u \in A $
