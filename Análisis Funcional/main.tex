...
Lo que querremos estudiar en esta sección será el sistema:
...
\begin{definition}
    ...
    Las funciones con las que trabajaremos en este apartado son las de este tipo con soporte compacto.
\end{definition}
...
\begin{demonstration}
    ...
    Como esto lo podemos hacer para un $ \varepsilon $ arbitrario, tenemos que $ <u,v>_{D} = 0 $, luego:
